...
class productClass:
    def __init__(self,root):
        ...
        #------------ title --------------
        title=Label(product_Frame,text="Return Items Sold",font=("goudy old style",24,"bold"),bg="#784212",fg="white",height=2).pack(side=TOP,fill=X)
        ...
        self.ProductTable=ttk.Treeview(product_frame,columns=("name","date","qty_sold","current_stock"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
        ...
        self.ProductTable.heading("qty_sold",text="Suppler")
        self.ProductTable.heading("name",text="Name")
