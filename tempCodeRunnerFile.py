...
class ModernSalesAnalysisApp:
    ...
    def build_trends_tab(self):
        ...
        # 14-day trend tab
        trend_14_frame = tk.Frame(graph_notebook, bg="#f5f6fa")
        graph_notebook.add(trend_14_frame, text="14-Day Trend")
        self.plot_14_day_trend(trend_14_frame)
        
        # 30-day trend tab
        trend_30_frame = tk.Frame(graph_notebook, bg="#f5f6fa")
        graph_notebook.add(trend_30_frame, text="30-Day Trend")
        self.plot_30_day_trend(trend_30_frame)
    ...
    def plot_14_day_trend(self, parent_frame):
        ...
        self.lines_14 = []  # Store line objects for hover functionality
        ...
        for i, product in enumerate(top_products):
            ...
            line, = ax.plot(days, past_sales[-14:], 
                           ...
                           linewidth=2,
                           markersize=6)
            self.lines_14.append(line)
        
        ax.set_title("Top Products - 14-Day Sales Trend", fontsize=12, pad=20)
    ...
    def plot_30_day_trend(self, parent_frame):
        fig = Figure(figsize=(8, 5), dpi=100)
        ax = fig.add_subplot(111)
        ...
        self.lines_30 = []  # Store line objects for hover functionality
        ...
        for i, product in enumerate(top_products):
            ...
            line, = ax.plot(last_30_days, past_sales_30, 
                           ...
                           markersize=4,
                           alpha=0.8)
            self.lines_30.append(line)
        
        ax.set_title("30-Day Sales Trend (Top Products)", fontsize=12, pad=20)
        ax.set_xlabel("Date", fontsize=10)
        ax.set_ylabel("Units Sold", fontsize=10)
